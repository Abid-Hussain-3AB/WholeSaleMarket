...
public class CosmeticsFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_cosmetics, container, false);
        recyclerView = v.findViewById(R.id.rc_cosmetics);
        ...
        mFirebaseDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    if (ds.hasChild("Cosmetics")) {
                        for (DataSnapshot dataSnapshot1 : ds.child("Cosmetics").getChildren()) {
