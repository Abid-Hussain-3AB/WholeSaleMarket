...
public class VehiclePartsFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_vehicle_parts, container, false);
        recyclerView = v.findViewById(R.id.rc_vehicle);
        ...
        mFirebaseDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    if (ds.hasChild("VehicleParts")) {
                        for (DataSnapshot dataSnapshot1 : ds.child("VehicleParts").getChildren()) {
