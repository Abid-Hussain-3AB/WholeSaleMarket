...
public class HomeAppliancesFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_home_appliances, container, false);
        recyclerView = v.findViewById(R.id.rc_homeappliances);
        ...
        mFirebaseDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    if (ds.hasChild("Home Appliances")) {
                        for (DataSnapshot dataSnapshot1 : ds.child("Home Appliances").getChildren()) {
