...
public class ElectronicsFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_electronics, container, false);
        recyclerView = v.findViewById(R.id.rc_electronics);
        ...
        mFirebaseDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    if (ds.hasChild("Electronics")) {
                        for (DataSnapshot dataSnapshot1 : ds.child("Electronics").getChildren()) {
